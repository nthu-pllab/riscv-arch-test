...
VALS = {
    ...
    'pbrdrrformat': 'simd_val_vars("rs1", xlen, 8) + simd_val_vars("rs2", xlen, 8) + simd_val_vars("rd", xlen, 8)',
    'phrdrrformat': 'simd_val_vars("rs1", xlen, 16) + simd_val_vars("rs2", xlen, 16) + simd_val_vars("rd", xlen, 16)',
    'pwrdrrformat': 'simd_val_vars("rs1", xlen, 32) + simd_val_vars("rs2", xlen, 32) + simd_val_vars("rd", xlen, 32)',
